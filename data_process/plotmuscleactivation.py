...
path1 = "/home/shuzhen/Exo_human_walk_test4_human6_copy2/build/result1/"
...
fig, (ax1, ax2, ax3, ax4,ax5,ax6, ax7, ax8, ax9,ax10,ax11) = plt.subplots(11)
...
ax11.plot(y_new, mean15, color="red", linewidth=1.5,  label="Vastus_Medialis")
...
ax11.fill_between(y_new, mean15+std15, std_new15, facecolor='red', alpha=0.2)
