...
public:
	...
	double Getf_p();
	double Getl_mt();
	std::string GetMuscleUnitName() {return name;}
	double GetMuscleUnitactivation() {return activation;}
	...
	void Sethumandof(int humandof){mhumandof=humandof;}
	int Gethumandof(){return mhumandof;}
	int Sethumanbodynodes(int humanbodynodes){mhumanbodynodes=humanbodynodes;}
	int Gethumanbodynodes(){return mhumanbodynodes;}
	void Setf0(double a) {f0 = a;}
...
public:
	...
	double f0; //maximum isometric force
